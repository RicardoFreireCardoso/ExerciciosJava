...
/*Faça um programa que apresente um menu de opções para o cálculo das seguinte operações entre dois números:
 * Adição (opção 1)
 * subtração (opção 2)
 * multiplicação (opção 3)
 * divisão (opção 4)
 * saída (opção 5)
 * O programa deve possibilitar ao usuário a escolha da operação desejada, a exibição do resultado e a volta ao menu de opções. O programa só termina quando for escolhida a opção de saída.
 * */
public class Ex47 {
